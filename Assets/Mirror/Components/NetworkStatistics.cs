...
namespace Mirror
{
    ...
    {
        [SerializeField] private bool _uiEnable;
        // update interval
        ...
        // long bytes to support >2GB
        public static int  clientReceivedPacketsPerSecond;
        public static long clientReceivedBytesPerSecond;
        public static int  clientSentPacketsPerSecond;
        public static long clientSentBytesPerSecond;
        ...
        public static string GetSentPacketsInfo()
        {
            return $"Send: {clientSentPacketsPerSecond} msgs @ {Utils.PrettyBytes(clientSentBytesPerSecond)}/s";
        }
        
        public static string GetReceivedPacketsInfo()
        {
            return $"Recv: {clientReceivedPacketsPerSecond} msgs @ {Utils.PrettyBytes(clientReceivedBytesPerSecond)}/s";
        }
