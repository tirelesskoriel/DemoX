...
namespace Mirror
{
    ...
    public static partial class NetworkClient
    {
        ...
        static NetworkIdentity SpawnSceneObject(ulong sceneId)
        {
            ...
            if (identity == null)
            {
                Debug.LogError($"Spawn scene object not found for {sceneId}. Make sure that client and server use exactly the same project. This only happens if the hierarchy gets out of sync.");
