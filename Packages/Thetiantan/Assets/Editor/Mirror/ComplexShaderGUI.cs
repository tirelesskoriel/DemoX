    ...
    internal class ComplexShaderGUI : ShaderGUI
    {
        ...
        void DoReflectionArea(Material material)
        {
            ...
            //mix reflection probes
            {
                ...
                mix = EditorGUILayout.Toggle(Styles.mixRefProbes, mix);
