...
        [Tooltip("Enables the culling distance calculations.")]
        ...
        [NonSerialized]
        public Camera _camera; //real cam
        //[NonSerialized]
        ...
        private Camera RenderMe(CameraShadeMultiManager manager, StereoTargetEyeMask stereoTargetEyeMask, Camera sentCamera, bool invert = true, bool renderCam = true)
        {
            ...
            try
            {
                ...
                _cameraManager.Draw(_rendererManager, _renderTextureManager,
                    //_context, 
                    manager, stereoTargetEyeMask, invert, renderCam);
        ...
        public void UpdateMaterials(RenderTextureManager renderTextureManager)
        {
            ...
            foreach (var mat in _materials)
            {
                ...
                if (mat.HasProperty("_ReflectionTex"))
                    mat.SetTexture("_ReflectionTex", renderTextureManager.GetLeftOrCenterRenderTexture());

                if (mat.HasProperty("_ReflectionTexOther"))
                    mat.SetTexture("_ReflectionTexOther", renderTextureManager.GetRightRenderTexture());
            }
        }
...
            }
            ...
            //if (EnableSimpleDepth || EnableDepthBlur || WorkingType == this.WorkingType.Water)
            //{
