        ...
        SubShader{
            Pass{
                ...
                float4 frag(v2f i) :SV_Target{
                    float4 decal;
                    //解决四周拖影:判断垂直水平，如果在0.0001与0.9999之外则返回0
                    //解决背面拖影:判断如果垂直水平值小于0(代表渲染在摄像机背后)则返回0
                    if (i.uvDecal.x / i.uvDecal.w < 0.0001 || i.uvDecal.x / i.uvDecal.w > 0.9999  || i.uvDecal.y / i.uvDecal.w < 0.0001 || i.uvDecal.y / i.uvDecal.w > 0.9999 || i.uvDecal.x < 0 || i.uvDecal.y < 0|| i.uvDecal.z < 0|| i.uvDecal.w < 0)
                    {
